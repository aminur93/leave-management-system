...
export default {
  ...
  methods: {
    ...
    deleteRole: async function(id){
      try {
        await this.$store.dispatch("roles/DeleteRole", id).then(() => {
              ...
              <v-row>
                ...
                <v-col cols="6">
                  <v-card-actions class="justify-end">
                    <v-btn color="success" router to="/add-role">
                ...
                >
                  ...
                  <template v-slot:[`item.actions`]="{ item }">
                    <v-row align="center" justify="center">
                      <td :class="['mx-2']">
                        <v-btn color="warning" icon="mdi-pencil" size="x-small" router :to="`/edit-role/${item.id}`"></v-btn>
                      </td>
